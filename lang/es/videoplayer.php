...
$string['completionpercentage_help'] = 'Porcentaje necesario para considerar este recurso como completado. En PDF se calcula con páginas realmente visualizadas y en video con rangos únicos realmente reproducidos.';
$string['disablecontextmenu'] = 'Desactivar clic derecho y acciones básicas de copia';
$string['disabledownload'] = 'Desactivar descarga';
$string['disabledownload_help'] = 'Oculta acciones de descarga y sirve el recurso en línea mediante el proxy protegido. Esto dificulta la descarga directa, pero no puede impedir capturas de pantalla o extracción avanzada desde el navegador.';
$string['displaymode'] = 'Modo de visualización PDF';
$string['displaymode_help'] = 'Elija el visor PDF.js estándar con búsqueda o la experiencia de libro protegido para recursos compatibles con PDF.';
$string['displaymodeebook'] = 'Visor tipo libro protegido';
$string['displaymodestandard'] = 'Visor PDF estándar con búsqueda';
...
$string['modulename_help'] = 'Use esta actividad para publicar recursos protegidos desde Google Drive o almacenamiento local de Moodle, incluidos videos, PDF, imágenes, documentos, hojas de cálculo y presentaciones.';
...
$string['pagesviewed'] = '{$a} páginas visualizadas';
$string['pdfjsrequired'] = 'No se pudo cargar el visor local PDF.js. Verifique que thirdpartylibs/pdfjs/pdf.min.mjs y thirdpartylibs/pdfjs/pdf.worker.min.mjs estén instalados.';
...
$string['privacy:metadata:videoplayer_views:lastpage'] = 'Última página PDF visualizada.';
...
$string['privacy:metadata:videoplayer_views:timespent'] = 'Tiempo activo acumulado.';
$string['privacy:metadata:videoplayer_views:totalpages'] = 'Total de páginas detectadas.';
$string['privacy:metadata:videoplayer_views:totalseconds'] = 'Duración total del video guardada para calcular el progreso.';
...
$string['privacy:metadata:videoplayer_views:visitedpages'] = 'Conjunto de páginas PDF observadas para calcular el progreso exacto.';
$string['privacy:metadata:videoplayer_views:watchedranges'] = 'Rangos normalizados de reproducción realmente vistos por el usuario.';
...
$string['protectedresourceunavailable'] = 'El recurso protegido no está disponible actualmente o no puede transmitirse.';
...
$string['searchpdfresultpage'] = 'Resultado en la página';
...
$string['setting_defaultrequiredseconds_desc'] = 'Tiempo activo predeterminado en segundos para recursos genéricos con seguimiento por presencia.';
$string['setting_enabletracking'] = 'Activar seguimiento de progreso';
$string['setting_enabletracking_desc'] = 'Registra el progreso y el estado de interacción del usuario.';
...
$string['setting_protectedmode_desc'] = 'Oculta enlaces directos hacia Google Drive y enruta los recursos compatibles mediante visores propios de Moodle.';
...
$string['trackingdisabled'] = 'El seguimiento de progreso está desactivado por el administrador del sitio.';
