...
$string['completionpercentage_help'] = 'Percentage required to consider this resource completed when progress tracking is available. For PDFs, the standard viewer calculates progress from pages actually viewed.';
...
$string['privacy:metadata:videoplayer_views:timespent'] = 'The cumulative active reading time saved for the user.';
