...
$string['completionpercentage_help'] = 'Percentage required to consider this resource completed when progress tracking is available. For PDFs, the standard viewer calculates progress from pages actually viewed. For video, progress is calculated from unique playback ranges actually watched.';
...
$string['displaymode_help'] = 'Choose the standard searchable PDF.js viewer or the protected book experience for PDF-compatible resources.';
$string['displaymodeebook'] = 'Protected book viewer';
$string['displaymodestandard'] = 'Standard searchable PDF viewer';
...
$string['privacy:metadata:videoplayer_views:lastpage'] = 'The last PDF page viewed by the user.';
...
$string['privacy:metadata:videoplayer_views:timespent'] = 'The cumulative active time saved for the user.';
...
$string['searchpdfresultpage'] = 'Result on page';
...
$string['setting_defaultrequiredseconds_desc'] = 'Default active time in seconds required to consider a generic resource sufficiently viewed when presence-based tracking is used.';
$string['setting_enabletracking'] = 'Enable progress tracking';
$string['setting_enabletracking_desc'] = 'When enabled, Drive Resource records user progress and interaction state in the activity.';
...
$string['setting_protectedmode_desc'] = 'When enabled, Drive Resource hides direct Google Drive navigation links and routes supported resources through Moodle-owned viewers.';
...
$string['trackingdisabled'] = 'Progress tracking is disabled by the site administrator.';
